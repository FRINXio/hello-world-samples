 ...
 * <i>kitchen-service-impl/modules/module/state/(urn:opendaylight:params:xml:ns:yang:controller:config:kitchen-service:impl?revision=2014-01-31)kitchen-service-impl</i>
 *
 */
public interface KitchenServiceImpl
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.kitchen.service.impl.rev140131.modules.module.state.KitchenServiceImpl>,
    State
{
