 ...
 *
 */
public class KitchenServiceImplBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.kitchen.service.impl.rev140131.modules.module.state.KitchenServiceImpl> {
    ...
    public KitchenServiceImplBuilder(KitchenServiceImpl base) {
        if (base instanceof KitchenServiceImplImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.kitchen.service.impl.rev140131.modules.module.state.KitchenServiceImpl> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.kitchen.service.impl.rev140131.modules.module.state.KitchenServiceImpl>) base;
    ...
    public KitchenServiceImplBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.kitchen.service.impl.rev140131.modules.module.state.KitchenServiceImpl>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
