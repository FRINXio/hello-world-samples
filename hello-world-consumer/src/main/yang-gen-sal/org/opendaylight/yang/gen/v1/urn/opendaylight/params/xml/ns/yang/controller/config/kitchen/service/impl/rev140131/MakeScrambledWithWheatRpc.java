 ...
 * <i>kitchen-service-impl/make-scrambled-with-wheat-rpc</i>
 *
 */
public abstract class MakeScrambledWithWheatRpc extends BaseIdentity
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:kitchen-service:impl",
        "2014-01-31", "make-scrambled-with-wheat-rpc").intern();


    public MakeScrambledWithWheatRpc() {
