...
public class ToasterTest {
    ...
    private Option toasterBundles() {
        return new DefaultCompositeOption(
                mavenBundle("com.customer", "hello-world-provider").versionAsInProject(),
                mavenBundle("com.customer", "hello-world-consumer").versionAsInProject(),
                mavenBundle("com.customer", "hello-world").versionAsInProject(),
