...
* Generated at: Fri Oct 21 17:13:23 CEST 2016
*
* Do not modify this file unless it is present under src/main directory
*/
package org.opendaylight.controller.config.yang.config.toaster_provider.impl;
@org.opendaylight.yangtools.yang.binding.annotations.ModuleQName(namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:toaster-provider:impl", name = "toaster-provider-impl", revision = "2014-01-31")

public abstract class AbstractToasterProviderModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractToasterProviderModule> implements org.opendaylight.controller.config.yang.config.toaster_provider.impl.ToasterProviderModuleMXBean,org.opendaylight.controller.config.api.RuntimeBeanRegistratorAwareModule {
